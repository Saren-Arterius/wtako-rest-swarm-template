...
export PATRONI_RESTAPI_CONNECT_ADDRESS="$DOCKER_IP:${PATRONI_RESTAPI_PORT}"
export PATRONI_RESTAPI_LISTEN="0.0.0.0:${PATRONI_RESTAPI_PORT}"
...
export PATRONI_POSTGRESQL_CONNECT_ADDRESS="$DOCKER_IP:${PATRONI_POSTGRES_PORT}"
export PATRONI_POSTGRESQL_LISTEN="0.0.0.0:${PATRONI_POSTGRES_PORT}"
...
exec python3 /patroni.py ${PATRONI_POSTGRES_YML}
